                ...
                <div class="col-lg-6">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="" role="form" method="post" action="https://app.techsoft-web-agency.com/user/sms/post-bulk-sms"
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="help">(Applicable uniquement aux contacts entrés dans le champs destinaires ci-dessous
                                        )</span>
                                    <select class="selectpicker form-control" name="country_code" data-live-search="true">
					<option value="0"  selected  >Existe déjà sur le numéro de téléphone</option>                                                                                    <option value="93"  >Afghanistan (93)</option>
                                ...
                                <div class="form-group">
                                    <label>Destinataires (Facultatif. Complétez votre liste de contacts en saisissant les numéros ici) </label>
                                    <textarea class="form-control" rows="4" name="recipients" id="recipients"></textarea>
                                    <span class="help text-uppercase pull-right">Nombre total de destinataires
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="message" rows="5" id="message"></textarea>
										...
										<!-- original <span class="help text-uppercase" id="remaining">160 caractères restants</span>
                                    <span class="help text-success" id="messages">1 Message
                                        (s)</span>
									Original -->
                                </div>
							...
							Original -->
                                ...
                                <div class="form-group">
                                    <div class="coder-checkbox">
                                        <input type="checkbox" name="send_later"  checked  class="send_later" value="on">
                                        <span class="co-check-ui"></span>
                                ...
                                <div class="schedule_time">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control dateTimePicker" name="schedule_time" value="03/28/22 17:52 22">
                                    </div>
                                </div>
								<div class="form-group contact-list-area sr-only">
                                    <label></label>
                                    <input id="input_bad_numbers"class="form-control selectpicker select_contact_group"
                                            name="bad_numbers[]"> 
                                </div>
                                <input type="hidden" value="1" id="schedule_sms_status"
                                       name="schedule_sms_status">
                                <button type="submit" class="btn btn-success btn-sm" name="action" value="send_now"><i
                                            class="fa fa-send"></i> Envoyer
                                </button>
                            </form>
