...
@section('container')
    ...
    <section class="wrapper-bottom-sec">
        <div class="p-30">
            <h2 class="page-title">Envoyer Envoyer des SMS récurrents</h2>
        </div>
                ...
                <div class="col-lg-6">
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">Envoyer Envoyer des SMS récurrents</h3>
                        </div>
                        <div class="panel-body">

                            <form class="" role="form" method="post" action="https://app.techsoft-web-agency.com/user/sms/post-recurring-sms" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>Sélectionner le type de contact</label>
                                    <select class="selectpicker form-control" name="contact_type"  id="contact_type">
                                        <option value="phone_book">Répertoire de contact</option>
                                                                            </select>
                                </div>

                                
                                <div class="form-group contact-list-area">
                                    <label>Sélectionnez la ou les liste(s) de contacts à envoyer</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="help">(Applicable uniquement aux contacts entrés dans le champs destinaires ci-dessous)</span>
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="help text-uppercase pull-right">Nombre total de destinataires: <span class="number_of_recipients bold text-success m-r-5">0</span></span>
                                </div>

                                <div class="form-group">
                                    <label>Sélectionnez le signe qui sépare les numéros: </label>
                                    <div class="btn-group btn-group-sm" data-toggle="buttons">

                                        <label class="btn btn-default active">
                                            <input type="radio" name="delimiter" value="automatic" checked="">Automatique
                                        </label>
                                        ...
                                        <label class="btn btn-default">
                                            <input type="radio" name="delimiter" value="tab">Onglet
                                        </label>

                                        <label class="btn btn-default">
                                            <input type="radio" name="delimiter" value="new_line">Nouvelle ligne
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Insérer champ issus du fichier/ de la liste</label>
                                    <select class="form-control selectpicker" id="merge_value">
                                        <option value="" disabled selected style="display:none;">Sélectionner un champ  issus du fichier/ de la liste</option>
                                        <option value="<%Phone Number%>">Numéro de téléphone</option>
                                        <option value="<%Email Address%>">Email Adresse</option>
                                        <option value="<%User Name%>">Nom d&#039;utilisateur</option>
                                        <option value="<%Company%>">Entreprise</option>
                                        <option value="<%First Name%>">Prénom</option>
                                        <option value="<%Last Name%>">Nom</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="message" rows="5" id="message"></textarea>
										...
										<!-- original 
                                    <span class="help text-uppercase" id="remaining">160 caractères restants</span>
                                    <span class="help text-success" id="messages">1 Message(s)</span>
										Original -->
                                </div>
							...
							Original -->
                                    ...
                                    <div class="form-group input-group input-group-file">
                                        <span class="input-group-btn">
                                            <span class="btn btn-primary btn-file">
                                                Parcourir <input type="file" class="form-control" name="image" accept="audio/*,video/*,image/*">
                                            </span>
                                        </span>
                                ...
                                <div class="form-group">
                                    <label>Période de récurrence</label>
                                    <select class="selectpicker form-control" id="period" name="period">
                                        <option value="day">Quotidien</option>
                                        <option value="week1">Hebdomadaire</option>
                                        <option value="weeks2">2 Semaines</option>
                                        <option value="month1">Mois</option>
                                        <option value="months2">2 Mois</option>
                                        <option value="months3">3 Mois</option>
                                        <option value="months6">6 Mois</option>
                                        <option value="year1">Année</option>
                                        <option value="years2">2 Années</option>
                                        <option value="years3">3 Années</option>
                                        <option value="0">Date personnalisée</option>
                                    </select>
                                </div>

                                <div class="form-group recurring-time">
                                    <label>heure  de récurrence (heure d&#039;envoi)</label>
								...
								<div class="form-group contact-list-area">
                                    <label></label>
                                    <input id="input_bad_numbers"class="form-control selectpicker select_contact_group"
                                            name="bad_numbers[]"> 
                                </div>

                                <button type="submit" class="btn btn-success btn-sm" name="action" value="send_now"><i class="fa fa-send"></i> Envoyer </button>
                            </form>
