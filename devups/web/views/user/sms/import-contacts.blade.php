...
@section('container')
    ...
    <section class="wrapper-bottom-sec">
        <div class="p-30">
            <h2 class="page-title">Importer vos contacts</h2>
        </div>
        <div class="p-30 p-t-none p-b-none">
            <div class="show_notification"></div>
                ...
                <div class="col-lg-4">
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">Importer contact par fichier</h3>
                        </div>
                        <div class="panel-body">

                            <div class="form-group">
                                <div class="form-group">
                                    <a href="https://app.techsoft-web-agency.com/user/sms/download-contact-sample-file" class="btn btn-complete"><i class="fa fa-download"></i> Télécharger un exemple de fichier</a>
                                </div>
                            </div>

                            <div id="send-sms-file-wrapper">
                                <form class="" id="send-sms-file-form" role="form" method="post" action="https://app.techsoft-web-agency.com/user/post-import-file-contact" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group input-group input-group-file">
                                            <span class="input-group-btn">
                                                <span class="btn btn-primary btn-file">
                                                    Parcourir <input type="file" class="form-control" name="import_numbers" @change="handleImportNumbers">
                                                </span>
                                            </span>
                                    ...
                                    <div class="form-group" v-show="number_columns.length > 0">
                                        <label>Email Adresse Colonne</label>
                                    ...
                                    <div class="form-group" v-show="number_columns.length > 0">
                                        <label>Nom d&#039;utilisateur Colonne</label>
                                    ...
                                    <div class="form-group" v-show="number_columns.length > 0">
                                        <label>Entreprise Colonne</label>
                                    ...
                                    <div class="form-group">
                                        <label>Importer la liste dans <a href="/user/phone-book" class=""> ( Pas de liste de contacts ? Créez-en une ici )</a> </label>
                                    ...
                                    <div id='uploadContact' style='display:none' class="form-group">
                                        <label>Importation de contacts... Merci de patienter</label>
                                        <div class="progress">
                                            <div class="progress-bar-indeterminate"></div>
                                        </div>
                                    </div>
                                    ...
                                    <button type="submit" id="submitContact" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> Ajouter </button>
                                </form>
                            </div>
                ...
                <div class="col-lg-8">
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">Importer par saisie des numéros</h3>
                        </div>
                        <div class="panel-body">
                            <form class="" role="form" method="post" action="https://app.techsoft-web-agency.com/user/post-multiple-contact">

                                <div class="form-group">
                                    <label>Code du pays</label>
                                    <select class="selectpicker form-control" id=code_pays name="country_code" data-live-search="true">
                                        <option value="0"  selected  >Existe déjà sur le numéro de téléphone</option>
                                                                                    <option value="93"  >Afghanistan (93)</option>
                                                                                    <option value="355"  >Albania (355)</option>
                                                                                    <option value="213"  >Algeria (213)</option>
                                ...
                                <div class="form-group">
                                    <label>Coller / Entrer les numéros</label>
                                ...
                                <input type="hidden" name="_token" value="Noi8fbzKJPUo9D2TlUHaDU12qYjFshi2aFVBtaxf">
                                <button type="submit" id=CopyPasteNumbers class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> Ajouter </button>
                            </form>
                        </div>
                    </div>
                </div>
