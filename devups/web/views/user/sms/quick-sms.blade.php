...
@section('container')
    ...
    <section class="wrapper-bottom-sec">
        <div class="p-30">
            <h2 class="page-title">Envoyer SMS par saisie  des numéros</h2>
        </div>
        <div class="p-30 p-t-none p-b-none">
                        <div class="row">
                <div class="col-lg-6">
                    <div id=smsForm class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">Envoyer SMS par saisie  des numéros</h3>
                        </div>
                        <div class="panel-body">
                            <form class="" role="form" method="post" action="{{route('post-quick-sms')}}" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="_token" value="Noi8fbzKJPUo9D2TlUHaDU12qYjFshi2aFVBtaxf">
										...
										<p>
											<a href="{{route('sender-id-management')}}"
					 ...
					 <option value="0"  selected  >Existe déjà sur le numéro de téléphone</option>
							...
							Original -->
                                ...
                                <button type="submit" class="btn btn-success btn-sm"><i class="fa fa-send"></i> Envoyer </button>
                            </form>
